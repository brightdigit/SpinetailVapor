...
let package = Package(
  ...
  dependencies: [
    ...
    .package(name: "https://github.com/brightdigit/Spinetail", .branch("feature/repo-refactor")),
      .package(name: "https://github.com/brightdigit/PrchVapor.git", .branch("develop"))
  ],
  targets: [
